...
set id 2
set name calcPerceptron_fptrunc_64ns_32_2_1
...
set id 3
set name calcPerceptron_fpext_32ns_64_2_1
...
set id 6
set name calcPerceptron_dadd_64ns_64ns_64_5_full_dsp_1
...
set id 7
set name calcPerceptron_dmul_64ns_64ns_64_6_max_dsp_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 15 \
			corename calcPerceptron_CRTL_BUS_axilite \
			name calcPerceptron_CRTL_BUS_s_axi \
			ports {$port_CRTL_BUS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler calcPerceptron_CRTL_BUS_s_axi
}
