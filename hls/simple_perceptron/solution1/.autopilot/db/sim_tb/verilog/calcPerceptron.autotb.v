...
`define AUTOTB_TVIN_x  "./c.calcPerceptron.autotvin_x.dat"
`define AUTOTB_TVIN_w  "./c.calcPerceptron.autotvin_w.dat"
`define AUTOTB_TVIN_bias  "./c.calcPerceptron.autotvin_bias.dat"
`define AUTOTB_TVIN_res  "./c.calcPerceptron.autotvin_res.dat"
`define AUTOTB_TVIN_x_out_wrapc  "./rtl.calcPerceptron.autotvin_x.dat"
`define AUTOTB_TVIN_w_out_wrapc  "./rtl.calcPerceptron.autotvin_w.dat"
`define AUTOTB_TVIN_bias_out_wrapc  "./rtl.calcPerceptron.autotvin_bias.dat"
`define AUTOTB_TVIN_res_out_wrapc  "./rtl.calcPerceptron.autotvin_res.dat"
`define AUTOTB_TVOUT_res  "./c.calcPerceptron.autotvout_res.dat"
`define AUTOTB_TVOUT_res_out_wrapc  "./impl_rtl.calcPerceptron.autotvout_res.dat"
module `AUTOTB_TOP;
