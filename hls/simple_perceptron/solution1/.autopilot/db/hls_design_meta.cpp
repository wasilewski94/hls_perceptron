...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("res_Addr_A", 32, hls_out, 2, "bram", "MemPortADDR2", 1),
	Port_Property("res_EN_A", 1, hls_out, 2, "bram", "MemPortCE2", 1),
	Port_Property("res_WEN_A", 4, hls_out, 2, "bram", "MemPortWE2", 1),
	Port_Property("res_Din_A", 32, hls_out, 2, "bram", "MemPortDIN2", 1),
	Port_Property("res_Dout_A", 32, hls_in, 2, "bram", "MemPortDOUT2", 1),
